...
class ATEventExtender(object):
    ...
    # Even if the order is not modified, other packages which subclass this one
    # should be able to reorder fields
    ...
    fields = [
        ...
        TextFieldExtender('venue_notes',
            ...
            widget=atapi.TextAreaWidget(
                label=_(
                    u'label_event_venue_notes',
                    default=u'Alternativer Veranstaltungsort'),
                description=_(
                    u'description_event_venue_notes',
